...
def run(*, config_path: str) -> dict:
    ...
    # Initialize experiment file logging under the current experiment directory
    services.ExperimentLogger.initialize(log_filename="training.log")
